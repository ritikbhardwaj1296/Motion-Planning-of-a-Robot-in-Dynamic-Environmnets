...
def run_robot(robot):
    ...
    while robot.step(timestep) != -1:
        ...
        print(f"X: {round(gps_x, 2)}, Y: {round(gps_y, 2)}")
        # if gps_x < 0 and dist_obs1 < 0.8 and (h_angle_obs1 < 90 or h_angle_obs1 > 270):
            ...
            # else:
                # left_speed = max_speed
                # right_speed = max_speed
        # elif gps_x > 0 and dist_obs2 < 0.8 and (h_angle_obs2 > 90 or h_angle_obs2 < 270):
            ...
            # else:
                # left_speed = max_speed
                # right_speed = max_speed
        if gps_x < 0 and dist_obs1 < 0.6 and gps_y < values_obs1[1]:
            left_speed = -max_speed
            right_speed = -max_speed
            print("I'm going back...from obs1")
            
        elif gps_x > 0 and dist_obs2 < 0.6 and gps_y > values_obs2[1]:
            left_speed = -max_speed
            right_speed = -max_speed
            print("I'm going back...from obs2")                
            ...
            left_speed = max_speed*(1/6)
            right_speed = -max_speed*(1/6)
        elif round(gps_x, 2) == 0.15 and gps_y > 0 and (bearing_in_degrees<1 or bearing_in_degrees>270) :
            print("robot at point 4")
            left_speed = max_speed*(1/6)
            right_speed = -max_speed*(1/6)
        elif round(gps_y, 2) == -1.23 and round(gps_x, 1) > 0 and (bearing_in_degrees>268 or bearing_in_degrees<0.40):
            print("robot at point 5")
            left_speed = -max_speed*(1/6)
            right_speed = max_speed*(1/6)
        elif round(gps_x, 1) > 0.7 and gps_y < 0 and round(bearing_in_degrees, 0) != 180:
            left_speed = max_speed*(1/6)
            right_speed = -max_speed*(1/6)
